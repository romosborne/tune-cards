...
const storage = {
  ...
  loadSets(skipCache = false): Set[] {
    ...
    if (skipCache || local === null) {
      ...
      return [
        new Set(Metre.Square, [{ title: "On the Danforth", key: "A" }]),
        new Set(Metre.Square, [
          {
            title: "Redondo",
            key: "G",
            chordsA: ["G", "", "C", "D", "G", "", "", "Em"],
            chordsB: ["C", "G", "", "CD", "C", "G", "", "Em(C)"],
          },
          ...
          [
            {
              title: "Scollay's",
              key: "Em",
              chordsA: ["Em", "", "", "D", "Em", "", "B", "Em"],
              chordsB: ["C", "", "Am", "D", "Em", "GC", "B", "Em"],
            },
            {
              title: "Weir at Littlebeck",
              key: "F#m",
              chordsA: ["F#m", "G#m", "A", "B/A"],
              chordsB: ["D", "C#m", "F#5", "E", "D", "C#m", "F#", "AB"],
            },
          ],
        ...
        new Set(Metre.Jig, [
          { title: "Basil", key: "Bm" },
          {
            title: "AJ's",
            key: "E",
            chordsB: ["F#m", "E/G#", "C#m", "Bm", "A", "C#m", "D", "B"],
          },
        ]),
        new Set(
          Metre.Jig,
          [
            {
              title: "Calling Wood",
              key: "F",
              chordsA: ["F", "Bb", "F", "", "F", "Dm", "C", ""],
              chordsB: ["Dm", "C", "Bb", "", "Gm", "F", "C", ""],
            },
            {
              title: "Mrs O'Sullivans",
              key: "Dm",
              chordsA: ["C", "F", "G", "", "Am", "G", "F"],
            },
          ],
